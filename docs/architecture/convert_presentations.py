#!/usr/bin/env python3
"""
EZ Platform Architecture Presentations Converter
Converts HTML presentations to PDF, Markdown with SVG, and PowerPoint formats.
"""
...
class PresentationConverter:
    ...
    def html_to_screenshot(self, html_path):
    ...
    def html_to_powerpoint(self, html_path, output_path):
        """Convert HTML to PowerPoint with screenshot."""
        ...
        # Take screenshot
        screenshot_bytes = self.html_to_screenshot(html_path)
        ...
        img_path = output_path.parent / f"{output_path.stem}_temp.png"
        img.save(img_path)
