...
---
# צינור עיבוד הנתונים
_זרימה מקצה לקצה: קבצי מקור ← עיבוד ← פלט מרובה יעדים_

---

![צינור עיבוד הנתונים](../svg/data-pipeline_he.svg)
...
<text fill="#60a5fa" font-size="14" font-weight="bold" text-anchor="middle" x="100" y="50">קבצי מקור</text>
<rect fill="rgba(245,158,11,0.1)" height="280" rx="12" stroke="rgba(245,158,11,0.3)" width="680" x="200" y="20"></rect>
<text fill="#fbbf24" font-size="14" font-weight="bold" text-anchor="middle" x="540" y="50">צינור עיבוד</text>
<rect fill="rgba(16,185,129,0.1)" height="280" rx="12" stroke="rgba(16,185,129,0.3)" width="180" x="900" y="20"></rect>
<text fill="#34d399" font-size="14" font-weight="bold" text-anchor="middle" x="990" y="50">יעדים</text>
<!-- Source Files -->
<g filter="url(#shadow)">
...
<text fill="#93c5fd" font-size="10" text-anchor="middle" x="100" y="272">📥 קלט 50Gi</text>
<!-- Processing Services -->
<!-- File Discovery -->
<g filter="url(#shadow)">
<rect fill="url(#processGrad)" height="120" rx="10" width="140" x="230" y="100"></rect>
<text fill="white" font-size="12" font-weight="bold" text-anchor="middle" x="300" y="130">🔍 גילוי</text>
<text fill="white" font-size="12" font-weight="bold" text-anchor="middle" x="300" y="148">קבצים</text>
<line stroke="rgba(255,255,255,0.3)" x1="250" x2="350" y1="160" y2="160"></line>
<text fill="rgba(255,255,255,0.9)" font-size="10" text-anchor="middle" x="300" y="180">סקירת תיקיות</text>
<text fill="rgba(255,255,255,0.9)" font-size="10" text-anchor="middle" x="300" y="195">מניעת כפילויות</text>
...
<text fill="white" font-size="12" font-weight="bold" text-anchor="middle" x="490" y="130">⚙️ מעבד</text>
<text fill="white" font-size="12" font-weight="bold" text-anchor="middle" x="490" y="148">קבצים</text>
<line stroke="rgba(255,255,255,0.3)" x1="440" x2="540" y1="160" y2="160"></line>
<text fill="rgba(255,255,255,0.9)" font-size="10" text-anchor="middle" x="490" y="180">זיהוי פורמט</text>
<text fill="rgba(255,255,255,0.9)" font-size="10" text-anchor="middle" x="490" y="195">המרה ל-JSON</text>
...
<text fill="white" font-size="12" font-weight="bold" text-anchor="middle" x="680" y="130">✅ אימות</text>
...
<text fill="rgba(255,255,255,0.9)" font-size="10" text-anchor="middle" x="680" y="195">כללים עסקיים</text>
...
<text fill="white" font-size="11" font-weight="bold" text-anchor="middle" x="835" y="130">📤 פלט</text>
<line stroke="rgba(255,255,255,0.3)" x1="800" x2="870" y1="145" y2="145"></line>
<text fill="rgba(255,255,255,0.9)" font-size="9" text-anchor="middle" x="835" y="165">ריבוי</text>
<text fill="rgba(255,255,255,0.9)" font-size="9" text-anchor="middle" x="835" y="180">יעדים</text>
...
<text fill="white" font-size="11" font-weight="bold" text-anchor="middle" x="990" y="93">📁 קבצים מקומיים</text>
</g>
<g filter="url(#shadow)">
...
<text fill="white" font-size="11" font-weight="bold" text-anchor="middle" x="990" y="228">📨 תורי הודעות</text>
</g>
<!-- Storage indicator -->
<rect fill="rgba(16,185,129,0.3)" height="25" rx="4" width="120" x="930" y="255"></rect>
<text fill="#6ee7b7" font-size="10" text-anchor="middle" x="990" y="272">📤 פלט 100Gi</text>
...
<text fill="rgba(255,255,255,0.8)" font-size="11" text-anchor="middle" x="550" y="385">מונחה אירועים | MassTransit | 2 Brokers</text>
<!-- RabbitMQ queues/exchanges -->
<rect fill="rgba(139,92,246,0.2)" height="80" rx="8" stroke="rgba(139,92,246,0.4)" width="660" x="220" y="410"></rect>
<text fill="#c4b5fd" font-size="11" font-weight="bold" text-anchor="middle" x="550" y="435">Topics:</text>
<text direction="ltr" fill="#a5b4fc" font-size="10" text-anchor="start" x="240" y="455">📍 filepolling</text>
<text direction="ltr" fill="#a5b4fc" font-size="10" text-anchor="start" x="420" y="455">📍 filesreceiver.validationrequest</text>
<text direction="ltr" fill="#a5b4fc" font-size="10" text-anchor="start" x="240" y="475">📍 validation.completed</text>
<text direction="ltr" fill="#a5b4fc" font-size="10" text-anchor="start" x="480" y="475">📍 global.processingfailed</text>
...
<text fill="white" font-size="14" font-weight="bold" text-anchor="middle" x="550" y="535">HAZELCAST מטמון מבוזר</text>
...
<text fill="white" font-size="14" font-weight="bold" text-anchor="middle" x="350" y="660">⚠️ טיפול בשגיאות</text>
<rect fill="rgba(0,0,0,0.3)" height="50" rx="8" width="150" x="520" y="640"></rect>
<text fill="white" font-size="11" font-weight="bold" text-anchor="middle" x="595" y="665">רשומות פסולות</text>
...
<text fill="white" font-size="11" font-weight="bold" text-anchor="middle" x="750" y="665">עיבוד מחדש</text>
<text fill="rgba(255,255,255,0.8)" font-size="10" text-anchor="middle" x="750" y="680">ידני/אוטומטי</text>
<!-- Error flow arrows -->
...
<text fill="#fca5a5" font-size="9" transform="rotate(-90 150 500)" x="150" y="500">שגיאות אימות</text>
<!-- Performance metrics -->
<rect fill="rgba(255,255,255,0.05)" height="150" rx="10" stroke="rgba(255,255,255,0.1)" width="180" x="900" y="340"></rect>
<text fill="#94a3b8" font-size="12" font-weight="bold" text-anchor="middle" x="990" y="365">ביצועים</text>
<line stroke="rgba(255,255,255,0.1)" x1="920" x2="1060" y1="375" y2="375"></line>
<text direction="ltr" fill="#a5b4fc" font-size="10" text-anchor="start" x="910" y="400">⚡ &lt;1s per 100 records</text>
<text direction="ltr" fill="#a5b4fc" font-size="10" text-anchor="start" x="910" y="420">📊 95%+ cache hit rate</text>
<text direction="ltr" fill="#a5b4fc" font-size="10" text-anchor="start" x="910" y="440">🚀 &lt;5s service startup</text>
<text direction="ltr" fill="#a5b4fc" font-size="10" text-anchor="start" x="910" y="460">📈 P99 latency &lt;500ms</text>
<text direction="ltr" fill="#a5b4fc" font-size="10" text-anchor="start" x="910" y="480">✓ 1000 files tested</text>
</svg>
...
- [מערך ניטור →](./observability.md)


---

_Generated from data-pipeline.html_
_Date: 1766661424.196139_
