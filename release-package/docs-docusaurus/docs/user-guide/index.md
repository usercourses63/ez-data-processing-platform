...
# מדריך למשתמש - EZ Platform v0.5.0
...
- **אימות מחדש אוטומטי** של רשומות שגויות בעת שינוי סכמה
...
- **אימות מחדש אוטומטי** -- כאשר סכמת מקור נתונים מתעדכנת, רשומות שגויות נבדקות מחדש אוטומטית. רשומות שעוברות אימות מועברות לצינור העיבוד
- **כפתור "אמת מחדש הכל"** -- הפעלה ידנית מדף רשומות שגויות ומלשונית סכמה
- **TTL לרשומות שגויות** -- מחיקה אוטומטית של רשומות ישנות (ברירת מחדל: 4 ימים, ניתן לדריסה לפי מקור)
- **הורדת סכמה ב-YAML** -- לצד הורדת JSON הקיימת
- **התראות SignalR** -- הודעות toast בזמן אמת על תוצאות אימות מחדש
- **קישור לעריכת סכמה** -- מחלון תיקון רשומה ישירות ללשונית הסכמה
