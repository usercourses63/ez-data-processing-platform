...
ת: הסכמה החדשה עשויה לא לפתור את כל סוגי השגיאות. לדוגמה, שינוי pattern לא ישפיע על שגיאות מסוג required. בדוק את הודעות השגיאה המעודכנות -- הן משקפות את הסכמה החדשה. ראה [אימות מחדש אוטומטי](./auto-revalidation).
