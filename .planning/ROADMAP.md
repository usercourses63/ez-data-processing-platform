...
- [x] **Phase 29: Invalid Records Auto-Revalidation** - Auto-revalidate invalid records when datasource schema changes, bulk reprocessing pipeline, schema versioning, Hebrew user guide chapter with screenshots + Mermaid diagrams (completed 2026-03-26)
...
- [x] 26-03-PLAN.md — List page enable/disable redesign with completeness enforcement (CHECK-04)
- [x] 26-04-PLAN.md — Playwright E2E and webapp-testing comprehensive tests (CHECK-01, CHECK-02, CHECK-03, CHECK-04)
- [x] 26-05-PLAN.md — Gap closure: AJV schema validation, border fixes for all control types, sidebar missing fields, save feedback, list page mini ring (CHECK-01, CHECK-02, CHECK-04)
- [x] 26-06-PLAN.md — Gap closure: DemoDataGenerator completeness consistency (CHECK-04)
- [x] 26-07-PLAN.md — Gap closure: Updated tests for all gap fixes + production K8s deploy (CHECK-01, CHECK-02, CHECK-03, CHECK-04)
...
**Plans**: 5 plans (Wave 1: 27-01, 27-02, 27-04 parallel; Wave 2: 27-03; Wave 3: 27-05)
...
**Plans**: 9 plans (Wave 1: 28-01, 28-02, 28-03, 28-04 parallel; Wave 2: 28-05, 28-06 parallel; Wave 3: 28-07, 28-08 sequential; Wave 4: 28-09)

Plans:

- [x] 28-01-PLAN.md — Screenshot pipeline + Mermaid plugin install + capture 15 screenshots (DOC-09, DOC-10)
...
- [x] 28-07-PLAN.md — Build verification + Docker docs image + visual review checkpoint (DOC-09, DOC-10)
...
- [x] 29-01-PLAN.md — Backend core: SchemaUpdatedEvent, schema versioning, consumer, bulk revalidation with rate limiting (REVAL-01, REVAL-02, REVAL-03, REVAL-06, REVAL-07)
...
- [x] 29-06-PLAN.md — Playwright E2E test for revalidation workflow (REVAL-10)
- [x] 29-07-PLAN.md — Documentation: Hebrew user guide chapter, Docusaurus updates (REVAL-11, REVAL-12, REVAL-23, REVAL-24, REVAL-25, REVAL-26)
...
- [x] 30-01-PLAN.md — Fix OCP gaps (InvalidRecords Dockerfile USER, :latest tags) + OCP compliance verification script (OCP-01 through OCP-13)
...
- [x] 31-01-PLAN.md — Rewrite clone datasource E2E tests with production patterns
- [x] 31-02-PLAN.md — Upgrade import-from-file E2E tests with production patterns
- [x] 31-03-PLAN.md — Upgrade completeness checklist E2E tests with API context
- [x] 31-04-PLAN.md — Create i18n/RTL regression tests for v0.4.0/v0.5.0 features
